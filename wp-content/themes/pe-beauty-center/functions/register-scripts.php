...
/*-----------------------------------------------------------------------------------*/
	if(!function_exists('load_theme_styles')) {
			function load_theme_styles() {
					if (!is_admin()){
						...
						// register styles
						wp_register_style('bootstrap',  get_stylesheet_directory_uri() . '/bootstrap/css/bootstrap.min.css', array(), '3.3.5', 'all');
						wp_register_style('bootstrap_override',  get_stylesheet_directory_uri() . '/css/bootstrap_overrides.css', array(), '1.0', 'all');
						wp_register_style('fontawesome',  get_stylesheet_directory_uri() . '/css/font-awesome.min.css', array(), '4.3.0', 'all');
						wp_register_style('theme',  get_stylesheet_directory_uri() . '/css/template.css', array(), '1.0', 'all');
						wp_register_style('offcanvas',  get_stylesheet_directory_uri() . '/css/offcanvas.css', array(), '1.0', 'all');
						wp_register_style('comingsoon',  get_stylesheet_directory_uri() . '/css/comingsoon.css', array(), '1.0', 'all');
	...
	function load_admin_styles() {		
    	...
    	wp_enqueue_style( 'pe_admin', get_stylesheet_directory_uri() . '/css/pe-admin.css', array(), '1.0', 'all' );
...
/*-----------------------------------------------------------------------------------*/
	if(!function_exists('load_theme_scripts')){
	    function load_theme_scripts(){
			...
			wp_register_script('bootstrap.min', get_stylesheet_directory_uri().'/bootstrap/js/bootstrap.min.js', array('jquery'), true);
