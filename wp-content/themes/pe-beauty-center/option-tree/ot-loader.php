    ...
    private function constants() {
      ...
      if ( false == OT_THEME_MODE && false == OT_CHILD_THEME_MODE ) {
        ...
        if ( true == OT_CHILD_THEME_MODE ) {
          //$path = ltrim( end( @explode( get_stylesheet(), str_replace( '\\', '/', dirname( __FILE__ ) ) ) ), '/' ); //PE
          $path_base = explode( get_stylesheet(), str_replace( '\\', '/', dirname( __FILE__ ) ) ); //PE
		  $path = ltrim( end( $path_base ), '/' ); //PE
          ...
          $path_base = explode( get_template(), str_replace( '\\', '/', dirname( __FILE__ ) ) ); //PE
		  $path = ltrim( end( $path_base ), '/' ); //PE
